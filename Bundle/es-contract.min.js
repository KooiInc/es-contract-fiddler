...
In plaats daarvan wordt de voor dit contract toegekende standaardwaarde (${t(e,Function)?e.toString():t(e,String)?`"${e}"`:r(e)}) gebruikt`}}}var P=M,u,E=_({}),O=D(),T=R({language:"EN"});function M(t){E=_(t);let r={addContract:e,addContracts:n};return Object.freeze({contracts:r,IS:a,tryJSON:C});function n(o){if(!T.addContracts_Contract(o))return;let c=Object.entries(o);for(let[d,i]of c)e({...i,paramsChecked:!0,name:d})}function e(o){let{name:c,method:d,expected:i,defaultValue:m,customMessageFn:h,reportFn:k,shouldThrow:x,reportViolationsByDefault:l,paramsChecked:s,isBoolean:p=!1}=o;if(c=c||d?.name,i=i||"unknown",!s&&!O.checkSingleContractParameters({method:d}))return E.reporter(u.contractCreationError);let g=j({name:c,method:d,expected:i,defaultValue:m,reporter:t.reporter,reportFn:k,customMessageFn:h,reportViolationsByDefault:l,isBoolean:p,logViolations:t.logViolations,shouldThrow:x,alwaysThrow:t.alwaysThrow});return Object.defineProperty(r,c,{value:g})}}function _(t){return t.reporter=t.reporter||S,t.logViolations=t.logViolations||!1,t.alwaysThrow=t.alwaysThrow||!1,t.language=b({IS:a,tryJSON:C})[t.language||"EN"],u=t.language,t}function j(t){let{name:r,method:n,expected:e,defaultValue:o,customMessageFn:c,reportFn:d,reporter:i,logViolations:m,shouldThrow:h,reportViolationsByDefault:k,alwaysThrow:x,isBoolean:l}=t;return function(s,...p){let g=n(s,...p),N=$(g)||!l&&!g||l&&!a(s,Boolean),f=a(p[0],Object)&&{...p[0],value:s}||{value:s};if(d=d??i??S,a(c,Function)&&c(f),N){let V=a(e,Function)?e(f):e,w=o||f.defaultValue,[v,y]=[f.reportViolation??k,f.shouldThrow??h];if(v||y||m){let F=B({inputValue:s,defaultValue:w,shouldBe:V.trim(),fnName:r||n.name,isBoolean:l});if(y||x)throw new TypeError(F);i(F)}return l&&a(w,Boolean)?w:w||void 0}return g}}function B(t){let{inputValue:r,defaultValue:n,shouldBe:e,fnName:o,isBoolean:c}=t,d=!$(n)||c&&a(n,Boolean),i=u.report_sorry(o,A(r)),m=u.report_forValue(i),h=u.report_Expected(e);return z(`${m}${h}${d&&u.report_defaultValue(n)||""}`)}function D(){let t=o=>a(o,String)&&o.trim().length;return{nameOk:t,expectedOk:o=>a(o,String)&&o.length||a(o,Function),isMethod:o=>a(o,Function),checkSingleContractParameters:({name:o,method:c}={})=>t(o||c.name)&&a(c,Function)}}function R(){let{nameOk:t,expectedOk:r,isMethod:n,checkSingleContractParameters:e}=O;return{nameOk:t,isMethod:n,expectedOk:r,addContracts_Contract(o){let c=[...Object.entries(o)],d=a(o,Object)&&c.filter(([,i])=>e(i))||void 0;return d.length<c.length&&console.info(u.contractCreationError),d?.length>0?o:void 0},addContract_Contract:e}}function z(t,r=3){return t.replace(/\n/g,`
${" ".repeat(r)}`)}function $(t){return a(t,null,void 0)}function C(t){return H(()=>{let n=JSON.stringify(t);return/Infinity|NaN/.test(n)?n.replace(/"/g,""):n},t)}function A(t){let r=n=>a(n,String)?`"${n}"`:a(n,Object)?C(n):String(n);return a(t,String)?`"${t}"`:a(t,Object)?C(t):/Array\(/.test(t?.constructor.toString())?`[${[...t].map(r)}]`:String(t)}function S(t){console.info(t)}function H(t,r){try{return t()}catch(n){return console.error({isOk:n.name===expected,message:n.message,type:n.name}),r}}export{P as default};
