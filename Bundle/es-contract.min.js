import a from"https://unpkg.com/typeofanything@latest/src/typeofany.module.js";function b({IS:t,tryJSON:r,contractsPrefix:n}={}){return n=n?`${n}
...
In plaats daarvan wordt de voor dit contract toegekende standaardwaarde (${t(e,Function)?e.toString():t(e,String)?`"${e}"`:r(e)}) gebruikt`}}}var P=M,u,E=_({}),O=D(),T=R({language:"EN"});function M(t){E=_(t);let r={addContract:e,addContracts:n};return Object.freeze({contracts:r,IS:a,tryJSON:C});function n(o){if(!T.addContracts_Contract(o))return;let c=Object.entries(o);for(let[d,i]of c)e({...i,paramsChecked:!0,name:d})}function e(o){let{name:c,method:d,expected:i,defaultValue:h,customMessageFn:g,reportFn:k,shouldThrow:x,reportViolationsByDefault:l,paramsChecked:s,isBoolean:p=!1}=o;if(c=c||d?.name,i=i||"unknown",!s&&!O.checkSingleContractParameters({method:d}))return E.reporter(u.contractCreationError);let f=j({name:c,method:d,expected:i,defaultValue:h,reporter:t.reporter,reportFn:k,customMessageFn:g,reportViolationsByDefault:l,isBoolean:p,logViolations:t.logViolations,shouldThrow:x,alwaysThrow:t.alwaysThrow});return Object.defineProperty(r,c,{value:f})}}function _(t){return t.reporter=t.reporter||N,t.logViolations=t.logViolations||!1,t.alwaysThrow=t.alwaysThrow||!1,t.language=b({IS:a,tryJSON:C})[t.language||"EN"],u=t.language,t}function j(t){let{name:r,method:n,expected:e,defaultValue:o,customMessageFn:c,reportFn:d,reporter:i,logViolations:h,shouldThrow:g,reportViolationsByDefault:k,alwaysThrow:x,isBoolean:l}=t;return function(s,...p){let f=n(s,...p),S=$(f)||!l&&!f||l&&!a(s,Boolean),w=a(p[0],Object)&&{...p[0],value:s}||{value:s};if(d=d??i??N,a(c,Function)&&c(w),S){let V=a(e,Function)?e(w):e,m=o||w.defaultValue;(r||n.name)==="int"&&console.log(m);let[v,y]=[w.reportViolation??k,w.shouldThrow??g];if(v||y||h){let F=B({inputValue:s,defaultValue:m,shouldBe:V.trim(),fnName:r||n.name,isBoolean:l});if(y||x)throw new TypeError(F);i(F)}return l&&a(m,Boolean)?m:a(m,NaN)?NaN:m||void 0}return f}}function B(t){let{inputValue:r,defaultValue:n,shouldBe:e,fnName:o,isBoolean:c}=t,d=!$(n)||c&&a(n,Boolean),i=u.report_sorry(o,A(r)),h=u.report_forValue(i),g=u.report_Expected(e);return z(`${h}${g}${d&&u.report_defaultValue(n)||""}`)}function D(){let t=o=>a(o,String)&&o.trim().length;return{nameOk:t,expectedOk:o=>a(o,String)&&o.length||a(o,Function),isMethod:o=>a(o,Function),checkSingleContractParameters:({name:o,method:c}={})=>t(o||c.name)&&a(c,Function)}}function R(){let{nameOk:t,expectedOk:r,isMethod:n,checkSingleContractParameters:e}=O;return{nameOk:t,isMethod:n,expectedOk:r,addContracts_Contract(o){let c=[...Object.entries(o)],d=a(o,Object)&&c.filter(([,i])=>e(i))||void 0;return d.length<c.length&&console.info(u.contractCreationError),d?.length>0?o:void 0},addContract_Contract:e}}function z(t,r=3){return t.replace(/\n/g,`
